...
/**
 * Пороги за РЕАЛЬНИМ розподілом ризику змапованих скарг:
 * медіана 29, p90 42, максимум 52. Попередні пороги 80/60/30
 * були взяті зі шкали 0-100 і робили всю карту сірою —
 * жодна скарга не дотягувала до 60.
 */
function riskColor(risk: number) {
  if (risk >= 45) return '#b91c1c';
  if (risk >= 35) return '#dc2626';
