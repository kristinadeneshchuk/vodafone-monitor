      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg bg-amber-50 border border-amber-200 p-3 text-sm">
            ...
            порахована з відгуків абонентів, лежить у тому ж діапазоні, що й
            публічно заявлена автономність станцій: Vodafone називає 4–6 годин
            на акумуляторах, Київстар — до 10 годин.
          </div>
